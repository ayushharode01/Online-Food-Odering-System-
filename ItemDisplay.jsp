        ...
        <div class="main-content">
           ...
           <table class="table table-stripped"id="tabl" class="table"> 
            ...
            <tbody> 
             ...
             <div class="report-container" id="changes"> 
				...
				<div class="report-body"> 
                                     ...
                                     <form id="updatitem" method="post" enctype="multipart/form-data">
                                         ...
                                         <input type="text" id="id" name="id"><br><br>
                                           ...
                                           <td><input type="text" id="price" name="price"><br><br>
...
<script>
	     ...
	     data.forEach(function (item) { 
				    	 $("#tabl tbody").append('<tr> <td> '+item.id+' </td> <td> '+item.productname+' </td> <td> '+item.category+' </td> <td> '+item.price+' </td> <td> '+item.quantity+' </td><td> '+item.description+' </td><td> '+item.filename+' </td>  </td><td><button type="button" id="btn" class="getvalues">Edit</button></td><td><button type="button" id="btn" class="getid">Delete</button></td> </tr>'
                                                 ); 	    	
        });  
               });
